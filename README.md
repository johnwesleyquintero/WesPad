...
*   **AI Assistant (Optional):**
    ...
    *   *Powered by Google Gemini Flash 2.5/3.0*
*   **Quality of Life:**
    *   Export to `.md` or `.txt`.
...
*Security Note: Your API key is stored locally in your browser's `localStorage`. It is sent directly from your browser to Google's servers for inference. It is never sent to any WesPad backend (because there isn't one).*
